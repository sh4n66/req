...
BOT_TOKEN = environ.get('BOT_TOKEN', '5030500439:AAETW6k0E0oCf0NZ0PIZUOb8bFUT1n6umr4')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/25256796dbd8333d17fa8.jpg')).split()
NOR_IMG = environ.get('NOR_IMG', "https://telegra.ph/file/5ab644a338f3dcabe720f.jpg")
...
# Others
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001570289337').split()]
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+6dFSXHkiQ-ZmZGI1")
MSG_ALRT = environ.get('MSG_ALRT', 'Thank You MICHEAL SIR 💜')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001937748848'))
