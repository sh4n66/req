...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', MONGO_URL)
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+VlWmPPlAM385MzNl")
MSG_ALRT = environ.get('MSG_ALRT', '𝐓𝐡𝐚𝐧𝐤 𝐲𝐨𝐮 𝐃𝐫 സാത്താൻ 𝐒𝐢𝐫 💜')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', "-1002157075196"))
